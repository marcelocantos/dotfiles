...
```bash
node /Users/marcelo/.claude/get-shit-done/bin/gsd-tools.cjs validate health $REPAIR_FLAG
```
...
```bash
node /Users/marcelo/.claude/get-shit-done/bin/gsd-tools.cjs validate health
```
