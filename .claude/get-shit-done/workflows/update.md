...
if [ -f ./.claude/get-shit-done/VERSION ]; then
  ...
  echo "LOCAL"
elif [ -f /Users/marcelo/.claude/get-shit-done/VERSION ]; then
  cat /Users/marcelo/.claude/get-shit-done/VERSION
  echo "GLOBAL"
else
  echo "UNKNOWN"
fi
...
(Paths are relative to your install location: `/Users/marcelo/.claude/` for global, `./.claude/` for local)
...
**If GLOBAL install:**
```bash
rm -f /Users/marcelo/.claude/cache/gsd-update-check.json
```
