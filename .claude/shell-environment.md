...
**Read this before** editing any dotfile (`~/.zshrc`, `~/.zshenv`, `~/.zsh/*.zsh`, `~/.bashrc`, `~/.profile`), modifying aliases or shell functions, or troubleshooting shell startup behaviour.
